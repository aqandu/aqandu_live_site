...
function generateURL(route, parameters) {
  ...
  if (route === '/rawDataFrom') {
    ...
    url = `${urlRoute}?lat=${parameters.location.lat}&lon=${parameters.location.lon}&start_date=${parameters.start_date}&end_date=${parameters.end_date}&estimatesrate=${parameters.estimatesrate}`;
  }
